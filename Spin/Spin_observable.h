...
#else
          LAPACKE_dgesdd(LAPACK_ROW_MAJOR,'N', (lapack_int) m, (lapack_int) n, (double *)&psi_reshaped[0],(lapack_int) lda, &local_svd_spectrum[0], u, (lapack_int) ldu, vt, (lapack_int) ldvt);
#endif
#endif
          free((void *)work);
...
#else
        LAPACK_dsyevd(LAPACK_ROW_MAJOR, 'N', 'U', (lapack_int) sizeA, &psi_mat[0], (lapack_int) lda, &local_entanglement_spectrum[0], &work[0]);
#endif
#endif        
